...
<title>Project - http://xmlns.com/foaf/0.1/Project</title>
...
<div id="content"><jsp:include page="/header.jsp" flush="true" /> <jsp:include page="/menu.jsp" flush="true"><jsp:param name="caller" value="research" /></jsp:include><div id="centerCol">
   ...
   <geonames:Project subjectURI="${param.uri}">

   <h3>Default Properties</h3>
   <table>
      <tr><td>URI</td><td><a href="<geonames:ProjectSubjectURI/>"><geonames:ProjectSubjectURI /></a></td></tr>
      <tr><td>Label</td><td><geonames:ProjectLabel /></td></tr>
   </table>
